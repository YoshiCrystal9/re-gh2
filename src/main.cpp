...
class Gh2testApp : public rex::ui::WindowedApp, public rex::ui::WindowListener {
public:
    static std::unique_ptr<rex::ui::WindowedApp> Create(rex::ui::WindowedAppContext& ctx) {
        return std::make_unique<Gh2testApp>(ctx);
    }

    Gh2testApp(rex::ui::WindowedAppContext& ctx)
        : WindowedApp(ctx, "gh2test", "[game_directory]") {
    ...
    bool OnInitialize() override {
        ...
        // Create window
        window_ = rex::ui::Window::Create(app_context(), "gh2test", 1280, 720);
        if (!window_) {
...
GUEST_FUNCTION_HOOK(rex_sub_8239CA70, memset)
GUEST_FUNCTION_HOOK(rex_sub_8239CB70, memcpy)
GUEST_FUNCTION_HOOK(rex_sub_8239D4F0, memmove)
